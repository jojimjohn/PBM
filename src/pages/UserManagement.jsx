...
const PERMISSION_CATEGORIES = {
  ...
  'Employees': ['VIEW_EMPLOYEES', 'MANAGE_EMPLOYEES', 'DELETE_EMPLOYEES'],
  'Vehicles': ['VIEW_VEHICLES', 'MANAGE_VEHICLES', 'MANAGE_VEHICLE_TYPES'],
  'Tank Logs': ['VIEW_TANK_LOGS', 'MANAGE_TANK_LOGS'],
  'Expense Sheets': ['VIEW_EXPENSE_SHEETS', 'MANAGE_EXPENSE_SHEETS', 'APPROVE_EXPENSE_SHEETS']
}
