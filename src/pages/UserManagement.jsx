...
const PERMISSION_CATEGORIES = {
  'User Management': ['MANAGE_USERS', 'VIEW_USERS', 'CREATE_USERS', 'EDIT_USERS', 'DELETE_USERS', 'MANAGE_ROLES', 'VIEW_ROLES'],
  'Company': ['MANAGE_COMPANIES', 'VIEW_COMPANIES', 'SWITCH_COMPANIES'],
  'Customers': ['MANAGE_CUSTOMERS', 'VIEW_CUSTOMERS', 'CREATE_CUSTOMERS', 'EDIT_CUSTOMERS', 'DELETE_CUSTOMERS'],
  'Suppliers': ['MANAGE_SUPPLIERS', 'VIEW_SUPPLIERS', 'CREATE_SUPPLIERS', 'EDIT_SUPPLIERS', 'DELETE_SUPPLIERS'],
  'Materials': ['MANAGE_MATERIALS', 'VIEW_MATERIALS', 'CREATE_MATERIALS', 'EDIT_MATERIALS', 'DELETE_MATERIALS'],
  'Inventory': ['MANAGE_INVENTORY', 'VIEW_INVENTORY', 'EDIT_INVENTORY'],
  'Sales': ['MANAGE_SALES', 'VIEW_SALES', 'CREATE_SALES', 'EDIT_SALES', 'DELETE_SALES'],
  'Purchase': ['MANAGE_PURCHASE', 'VIEW_PURCHASE', 'CREATE_PURCHASE', 'EDIT_PURCHASE', 'DELETE_PURCHASE'],
  'Contracts': ['MANAGE_CONTRACTS', 'VIEW_CONTRACTS', 'CREATE_CONTRACTS', 'EDIT_CONTRACTS', 'DELETE_CONTRACTS'],
  'Collections': ['MANAGE_COLLECTIONS', 'VIEW_COLLECTIONS', 'CREATE_COLLECTIONS', 'EDIT_COLLECTIONS', 'DELETE_COLLECTIONS'],
  'Wastage': ['MANAGE_WASTAGE', 'VIEW_WASTAGE', 'CREATE_WASTAGE', 'EDIT_WASTAGE', 'DELETE_WASTAGE'],
  'Petty Cash': ['MANAGE_PETTY_CASH', 'VIEW_PETTY_CASH', 'CREATE_PETTY_CASH', 'EDIT_PETTY_CASH', 'DELETE_PETTY_CASH'],
  'Finance': ['MANAGE_FINANCE', 'VIEW_FINANCE', 'CREATE_FINANCE', 'EDIT_FINANCE', 'DELETE_FINANCE'],
  'Invoices': ['MANAGE_INVOICES', 'VIEW_INVOICES', 'CREATE_INVOICES', 'EDIT_INVOICES', 'DELETE_INVOICES'],
  'Banking': ['MANAGE_BANKING', 'VIEW_BANKING', 'CREATE_BANKING', 'EDIT_BANKING', 'DELETE_BANKING'],
  'Reports': ['MANAGE_REPORTS', 'VIEW_REPORTS'],
  'System': ['MANAGE_SETTINGS', 'VIEW_SETTINGS', 'MANAGE_BACKUPS'],
  'Projects': ['MANAGE_PROJECTS', 'VIEW_PROJECTS', 'CREATE_PROJECTS', 'EDIT_PROJECTS', 'DELETE_PROJECTS'],
  'Employees': ['MANAGE_EMPLOYEES', 'VIEW_EMPLOYEES', 'CREATE_EMPLOYEES', 'EDIT_EMPLOYEES', 'DELETE_EMPLOYEES'],
  'Vehicles': ['MANAGE_VEHICLES', 'VIEW_VEHICLES', 'CREATE_VEHICLES', 'EDIT_VEHICLES', 'DELETE_VEHICLES'],
  'Tank Logs': ['MANAGE_TANK_LOGS', 'VIEW_TANK_LOGS', 'CREATE_TANK_LOGS', 'EDIT_TANK_LOGS', 'DELETE_TANK_LOGS'],
  'Expense Sheets': ['MANAGE_EXPENSE_SHEETS', 'VIEW_EXPENSE_SHEETS', 'CREATE_EXPENSE_SHEETS', 'EDIT_EXPENSE_SHEETS', 'DELETE_EXPENSE_SHEETS']
}
