      ...
      const companies = [
        {
          ...
          modules: {
            enabled: ['dashboard', 'customers', 'suppliers', 'inventory', 'sales', 'purchase', 'contracts', 'collections', 'wastage', 'tank-logs', 'expense-sheets', 'petty-cash', 'banking', 'reports', 'projects', 'users', 'employees', 'vehicles', 'settings']
          }
        },
        {
          id: 'pridemuscat',
          ...
          modules: {
            enabled: ['dashboard', 'suppliers', 'inventory', 'sales', 'purchase', 'collections', 'wastage', 'tank-logs', 'expense-sheets', 'petty-cash', 'banking', 'reports', 'users', 'employees', 'vehicles', 'settings']
          }
        }
      ];
